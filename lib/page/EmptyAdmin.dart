...
class EmptyAdmin extends StatefulWidget {
  EmptyAdmin({Key key}) : super(key: key);

  @override
  _EmptyAdminState createState() => _EmptyAdminState();
}

class _EmptyAdminState extends State<EmptyAdmin> {
  String mineID;
  String token;
  DataUser dataUser;
  List<DataRoom> dataRoom;

  Future<bool> loadEmptyAdmin() async {
